...
var ConView = React.createClass({
    ...
    getInitialState: function getInitialState() {
        ...
        return {
            list: _store2.default.getState()
        };
    },
    conClick: function conClick(text) {
    ...
    componentDidMount: function componentDidMount() {
        _store2.default.subscribe(this.updateView);
    },
    ...
    render: function render() {
        return React.createElement(_view2.default, { data: this.state.list, clickFun: this.conClick });
    }
});

exports.default = ConView;
...
var _controllerView = __webpack_require__(92);

var _controllerView2 = _interopRequireDefault(_controllerView);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

(0, _reactDom.render)(React.createElement(_controllerView2.default, null), document.getElementById("app"));
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(32)))
...
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(91), __webpack_require__(183)(module)))
